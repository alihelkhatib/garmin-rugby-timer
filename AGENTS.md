...
- `resources/menus/menu.xml` defines the main menu stack; the new `view_log` entry surfaces the Event Log view so referees can review/export scored or discipline timestamps.

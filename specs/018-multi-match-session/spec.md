...
**Feature Branch**: `018-multi-match-session`
**Created**: 2026-03-10
**Status**: Draft
...
- **FR-004**: Each session log entry MUST include: match number, game type (7s / 15s; 10s label requires 002-custom-half-timer to be merged), home score, away score, and match start timestamp.

...
- New yellow cards now seed their `remaining` time immediately when logged, so the visible card timer starts at the full sanction duration on the very next redraw instead of waiting on a later timing pass.

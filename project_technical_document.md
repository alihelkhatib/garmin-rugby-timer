...
- The top scoreboard is a measured header band with separate lanes for elapsed timer, team labels, score digits, and center metadata. On compact round layouts the half/tries metadata sits inside the score band instead of extending the header downward, which keeps the main countdown visible on 240×240 devices.
